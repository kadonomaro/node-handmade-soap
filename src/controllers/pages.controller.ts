...
const getIndex = async (request: Request, response: Response) => {
...
const getBlog = async (request: Request, response: Response) => {
...
const getGallery = async (request: Request, response: Response) => {
...
const getFaq = async (request: Request, response: Response) => {
